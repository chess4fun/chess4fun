...
for (var i = 0; i < 1; i++)
{
    ...
    draw_text(550,60,theEntry[? "MOVE"]+" to move and Checkmate in "+string(global.my_level)+" move(s)");

    
       
    draw_text_ext(550,20,"Level : "+string(global.my_level)+"                                       Puzzle : "+string(global.my_puzzle), 30, 400);
    draw_line(550, 50, 950, 50);
    //draw_text_ext(550,70,"You are on puzzle "+string(global.my_puzzle), 30, 320);
    draw_text_ext(550,100,"1. "+theEntry[? "OPTION1"]+"#2. "+theEntry[? "OPTION2"]+"#3. "+theEntry[? "OPTION3"]+"#4. "+theEntry[? "OPTION4"]+"#", 30, 350);
    ...
    if global.answer = false 
    {
        ...
        draw_text_ext(550,430,'That is not correct, please try again', 30, 350); 
    } 
}
